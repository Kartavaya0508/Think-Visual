...
// Add light from the opposite side (left)
const leftlight = new THREE.DirectionalLight(0xffffff, 5);
bottomlight.position.set(150, 150, 150);
bottomlight.castShadow = true;
scene.add(leftlight);

// Add light from the opposite side (right)
const rightlight = new THREE.DirectionalLight(0xffffff, 10);
